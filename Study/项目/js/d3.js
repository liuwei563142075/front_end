...
function create$1(node, id, self) {
  ...
  function start(elapsed) {
    ...
    for (i in schedules) {
      ...
      // chance to tick (and possibly end); see d3-project/d3-project-transition#54!
    ...
    // Defer the first tick to end of the current frame; see d3-project/d3-project#1576.
    // Note the transition may be canceled after start and before the first tick!
    // Note this must be scheduled before the start event; see d3-project/d3-project-transition#16!
...
// Like d3-project.local, but with the name “__brush” rather than auto-generated.
...
// TODO Use d3-project-polygon’s polygonContains here for the ring check?
