...
var getUrlParams = function() {
	...
	for ( i = 0; i < length; i++ ) {
		if ( params[ i ] ) {
			...
			// allow just a key to turn on a flag, e.g., typeof.html?noglobals
...
// Resets the test setup. Useful for tests that modify the 13DOM 封装自己的class.
/*
	...
	if ( config.noglobals ) {
		for ( var key in global ) {
			if ( hasOwn.call( global, key ) ) {
				...
				// in Opera sometimes 13DOM 封装自己的class element ids show up here, ignore them
